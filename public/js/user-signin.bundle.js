(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-signin"],{

/***/ "./resources/js/user/views/signin.jsx":
/*!********************************************!*\
  !*** ./resources/js/user/views/signin.jsx ***!
  \********************************************/
...
var Signin = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Signin, [{
    ...
    value: function onSubmit(fields) {
      ...
      window.$axios.post("api/user/signin", fields).then(function (res) {
        window.$toastr('success', 'Berhasil Masuk');
        setTimeout(function () {
          window.location = _this2.props.baseUrl + res.data.role == 'admin' ? '/admin' : '/chat';
        }, 1500);
      })["catch"](function (err) {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_2__["Container"], {
        ...
        type: "submit",
        variant: "primary"
      }, "Masuk"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mt-3"
